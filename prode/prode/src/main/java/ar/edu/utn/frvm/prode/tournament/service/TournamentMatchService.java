...
public class TournamentMatchService {
    ...
    private void validateSameGroup(
            Tournament tournament,
            TournamentTeam homeTournamentTeam,
            TournamentTeam awayTournamentTeam,
            Integer itemNumber
        ...
        String homeGroup = homeTournamentTeam.getGroupName();
        String awayGroup = awayTournamentTeam.getGroupName();

        if (homeGroup == null
                || awayGroup == null
                || !homeGroup.equalsIgnoreCase(awayGroup)) {
