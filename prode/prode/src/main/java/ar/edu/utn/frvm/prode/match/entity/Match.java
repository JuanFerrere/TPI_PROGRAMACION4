 ...
 *
 * Un partido tiene una fecha, un equipo local, un equipo visitante, horario y
 * estado.
 */
...
public class Match {
     ...
     *
     * FetchType.LAZY evita cargar la fecha completa hasta que realmente se
     * necesite, lo que mejora rendimiento cuando se listan muchos partidos.
     */
    ...
    /**
     * Relacion JPA muchos-a-uno: muchos partidos pueden usar el mismo equipo
     * como local.
     *
     * No se usa cascada porque borrar o guardar un partido no debe borrar ni
     * crear equipos automaticamente.
     */
     ...
     * como visitante.
     *
     * Es una relacion separada de homeTeam porque el mismo partido necesita
     * distinguir local y visitante.
     */
     ...
     *
     * Se permite null para compatibilidad con partidos ya existentes en la
     * base: logicamente null se interpreta como REGULAR. Esta marca evita que,
     * cuando existan partidos eliminatorios, la tabla deportiva de grupos/liga
     * se contamine con resultados de eliminacion directa.
     */
    ...
    /**
     * Posicion del partido dentro de una llave eliminatoria. Queda null para
     * fase regular.
     */
    @Column
     ...
     * Se asigna al cargar el resultado de un partido KNOCKOUT para poder
     * avanzar la llave sin recalcular ganadores desde los goles en cada paso.
     */
    @ManyToOne(fetch = FetchType.LAZY)
     ...
     *
     * No recibe parametros. Asigna estado inicial POR_JUGARSE y timestamps en
     * UTC usando Instant. No devuelve nada porque modifica la entidad antes de
     * persistirla.
     */
     ...
     *
     * No recibe parametros. Guarda el instante exacto de actualizacion en UTC.
